...
If you're using the [Beam Companion](/sdk/companion) app, it might be good to know that as soon as you add a contract to your game, all connected users to profiles of your game are able to see said contract in the [Beam Companion](/sdk/companion) app.
