...
Would you like to start right away? Jump ahead to our SDKs for the [Unity](platform-clients/unity) and [Unreal](platform-clients/unreal) game engines. They utilize the self-custodial Player approach.
...
Keep in mind that actual [Account Abstraction](https://ethereum.org/en/roadmap/account-abstraction/) is deployed on the blockchain on first transaction performed by that profile. Because of this, the first transaction might be a bit slower than any subsequent action.
