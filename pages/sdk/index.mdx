...
Our tools allow you to introduce NFTs and Blockchain integration into your game via user-friendly [Account Abstractions](https://ethereum.org/en/roadmap/account-abstraction/). This way users can create on-chain Accounts without friction that is usually associated with storing Private Keys and security concerns. With a few clicks your players can create their Beam Wallets using Social Login options like Google, Apple or Discord and then interact with the blockchain from within your game in a safe and frictionless way.

Through [Sessions](/sdk/player-service/sessions/introduction) and [Policies](/sdk/automation-service/policies/introduction), you can provide a frictionless experience for your players, allowing them to interact with your game without dealing with on-chain transactions rr worrying about transaction fees.
