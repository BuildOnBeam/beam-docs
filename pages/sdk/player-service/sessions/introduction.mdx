...
While this sounds intimidating, we created a useful abstraction in Platform SDKs that allow you to generate a session, and ask the user to authorize those sessions through a web interface.
