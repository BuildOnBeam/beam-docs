...
In order to connect a user to your game, you can either start the Connection flow using one of our [Platform clients](../../index) or the [Player API](../../api/api-reference) directly.
