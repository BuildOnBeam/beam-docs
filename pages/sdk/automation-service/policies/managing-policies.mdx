...
Creating a policy is as simple as calling the `CreatePolicy` method. We highly recommend getting a good understanding about policies first by reading the [Understanding policies](/sdk/automation-service/policies/understanding-policies) section.
