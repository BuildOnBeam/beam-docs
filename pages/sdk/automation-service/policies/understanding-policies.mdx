...
In scenarios where users need to transact but lack the native currency for gas, Beam 'policies' provide a solution, allowing for payments in a specific ERC-20 token.

### Types of Policies for Transactions

#### 1. Fixed Charge Policies
**A set amount of the ERC-20 token is charged per transaction, regardless of the gas cost.**
...
**Charges in ERC-20 tokens are calculated based on the current gas cost, the developer needs to set and exchange rate of ERC-20 to wei in native currency.**
