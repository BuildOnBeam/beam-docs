...
Throughout time you'll run transactions to move on-chain assets for the [Profiles](/sdk/automation-service/profiles/creating-profiles) you create. As for all blockchains - for each transaction, gas needs to be spent in order to fulfill a transaction. In order to provide you with insights into the data, we provide a couple of simple methods that allow you to pull up this data.
