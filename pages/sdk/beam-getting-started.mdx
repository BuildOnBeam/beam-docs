...
<Steps>
    ...
    <Callout emoji="❗">
        ...
        You can read more about verifying your contracts in [Verifying Smart Contracts](/sdk/other-verifying-contracts).
    </Callout>
    ...
    **NOTE:** If you use a **Proxy Contract** for your main Smart Contract, select `custom ABI` switch. When adding a contract, include the ABI of your main contract in form of a JSON array. Your Proxy Contract still needs to be verified. Only use this option if you know what you are doing.
    ...
    Now we need to decide on the implementation strategy. You can read more about it in [Player API vs Automation API](/sdk/beam-player-vs-automation).
    Afterwards, just pick one of the generated [API Clients](/sdk/api/api-clients) and start coding.

    Would you like to start right away? Jump ahead to our SDKs for the [Unity](sdk/ingame-sdks/unity) and [Unreal](sdk/ingame-sdks/unreal) game engines which use self-custodial Player strategy.
