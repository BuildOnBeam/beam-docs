...
<Steps>
    ...
    First, head to our Dashboard. We recommend starting with the Beta environment first to get a feel for the platform. Register your game and obtain your API key there.
    ...
    Login with your preferred social login option and proceed to register your game.
    ...
    Afterward, a form will pop up. We need you to fill out some basic info about your game and set a few images (you can edit all of it later). Your players will see them and correlate actions they perform with your game.
    ...
    After confirming, the Wallet application of your choice will ask you to sign a message. This allows us to make sure that you are the owner of the game.
    ...
    **NOTE:** If you use a **Proxy Contract** for your main Smart Contract, select the `custom ABI` switch. When adding a contract, include the ABI of your main contract in the form of a JSON array. Your Proxy Contract still needs to be verified. Only use this option if you know what you are doing.
...
<Callout type="warning" emoji="⚠️">
    If you would like advice or need help finding a strategy that suits your needs, please contact us at build@onbeam.com. We can provide help with bridging existing assets through LayerZero provide assistance around smart contracts to get your in-game assets going.
</Callout>
