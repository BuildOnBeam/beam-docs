...
If you're interested in how we generate the clients, have a look at the [Github repository](https://github.com/BuildOnBeam/beam-api-clients). If you don't want to use our provided clients, it might still be of inspiration.

---

### Releases

If you are interested in more granular changelogs for SDK releases, have a look at our [Github releases](https://github.com/BuildOnBeam/beam-api-clients/releases)
...
- [Beam Automation OpenAPI specification](https://api.beta.onbeam.com/api/automation-json)
- [Beam Player OpenAPI specification](https://api.beta.onbeam.com/api/player-json)
