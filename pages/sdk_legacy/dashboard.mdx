...
To get started with your implementation on the Beam Network, we've created the [Beam Dashboard](https://dashboard.beta.onbeam.com). The Beam Dashboard allows you to manage your game, contracts, API keys, and network funds through a web app.
