...
Once that's done, you can start bootstrapping the Beam network. Follow the steps below or run this quick install script.

```bash
curl -s https://docs.onbeam.com/scripts/bootstrap-beam-network.sh | bash
```

## Bootstrap Beam Network
