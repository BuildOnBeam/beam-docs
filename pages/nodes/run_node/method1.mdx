...
Download the Subnet-EVM binary from the [AvalancheGo releases page](https://github.com/ava-labs/avalanchego/releases). Subnet-EVM is now maintained and released in the AvalancheGo repository.
...
install -m 0755 subnet-evm ~/.avalanchego/plugins/kLPs8zGsTVZ28DhP1VefPCFbCgS7o5bDNez8JUxPVw9E6Ubbz
```

<Callout type="info">
  AvalancheGo and Subnet-EVM must use the same RPCChainVM protocol version.
