...
![node-info](https://github.com/BuildOnBeam/beam-docs/blob/chore/nodes-documentation/pages/nodes/run_node/node-info-console.PNG)
...
![register-validator](https://github.com/BuildOnBeam/beam-docs/blob/chore/nodes-documentation/pages/nodes/run_node/register-validator.PNG)
...
![available-validators](https://github.com/BuildOnBeam/beam-docs/blob/chore/nodes-documentation/pages/nodes/run_node/available-validators.PNG)
