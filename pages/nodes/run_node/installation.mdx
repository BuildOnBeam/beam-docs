...
mkdir subnetevm
cd subnetevm
https://github.com/ava-labs/subnet-evm/releases/download/v0.7.2/subnet-evm_0.7.2_linux_amd64.tar.gz
...
Make sure to input the correct L1 Blockchain ID in the textbox: *"2tmrrBo1Lgt1mzzvPSFt73kkQKFas5d1AP88tv9cicwoFp8BSn"*. Once done, copy the code from the *"Node Command"* field and paste it into your command line terminal.
...
docker run -it -d \
    ...
    -e AVAGO_TRACK_SUBNETS=2tmrrBo1Lgt1mzzvPSFt73kkQKFas5d1AP88tv9cicwoFp8BSn \
    -e AVAGO_NETWORK_ID=fuji \
    avaplatform/subnet-evm:v0.7.2-fuji
```
If the container is running successfully, it's time to move onto the next step: [Register a validator](/nodes/run_node/register) 
