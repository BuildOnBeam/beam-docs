...
Make sure to input the correct L1 Blockchain ID in the textbox: *"y97omoP2cSyEVfdSztQHXD9EnfnVP9YKjZwAxhUfGbLAPYT9t"*. Once done, copy the code from the *"Node Command"* field and paste it into your command line terminal.
