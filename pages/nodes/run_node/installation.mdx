...
Beam Nodes became available following the completion of the Horizon upgrade. There are various ways to install a Validator Node, of which the recommended method is covered below.
