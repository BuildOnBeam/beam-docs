...
These rewards can be divided into [primary](/nodes/rewards/primary) and [secondary](/nodes/rewards/secondary) rewards. It's important to note that the exact calculations of the rewards will constantly change, and are, among other things, dependent on the total number of active validators, Node Tokens staked and BEAM staked.
