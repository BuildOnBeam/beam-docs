...
In the future, we hope to automatically assess major, minor and patch versions, but we currenlty rely on patch incrementals only.

---

### Beam OpenAPI Specification

Beam OpenAPI specification empowers you with a broad set of developer tooling, starting with Postman collections and generating your own SDK. It also services as the basis for our generated release changelogs and SDKs.
