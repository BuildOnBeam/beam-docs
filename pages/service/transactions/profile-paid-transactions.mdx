...
1. You could tell your users to increase their in-game account MC funding by asking them to send MC to it (which we do not consider a good experience for the user)
2. You could buy MC and distribute it to your in-game profiles through a treasury profile
...
Below you will find an exmaple how this would look like when managing assets in a Profile
