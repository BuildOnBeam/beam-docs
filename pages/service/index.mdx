...
To get started, obtain your API key for Beam by requesting it through hello@meritcircle.io. Then, read about how to make requests using our HTTP API or dedicated server side SDKs. We provide with numerous guides within this documentation on how to consume Beam
...
If you would like advice or need help finding a strategy that suits your needs, please contact us at hello@meritcircle.io - we can provide help with bridging existing assets through [LayerZero](https://layerzero.network/) or providing you with complete and audited contracts to get your in-game assets going.
...
Obtain your API key. If you haven't received any API key yet, please contact hello@meritcircle.io.


### Step 4 - Implement Beam
