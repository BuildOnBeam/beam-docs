...
Profiles are custodial, and through your API key you are able to transfer / trade and manage assets of the profiles of your users. Take into account that if you implement the [Beam Companion](/service/companion) app, that besides you as the developer - the user linked to the profile is also able to manage the assets through the app.
