...
To get started, obtain your API key for Beam by requesting it through build@onbeam.com. Then, read about how to make requests using our HTTP API or dedicated server side SDKs. We provide with numerous guides within this documentation on how to consume Beam
