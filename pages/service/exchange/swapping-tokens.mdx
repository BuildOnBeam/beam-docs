...
The API allows you to convert any in-game tokens or MC associated with a profile, using Beam's **decentralized exchange** [swap.onbeam.com](https://swap.onbeam.com).
...
We first need to get a quote and see how much MC we'd get by calling `getQuoteForOutput`, and passing in our _input_ amount of 1000.
...
call to `convertInputs`, which makes sure we spend _exactly_ 1000 in-game tokens, and receive _at least_ 10.1 MC.
