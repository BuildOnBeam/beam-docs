...
Through our new Player API implementation, you are able to set up self-custodial users with Beam. The implementation is a new service that works based on self-custodial private keys, and newly deployed account abstractions. Existing [Profiles](/service/profiles/introduction) that you created, won't be available in this new service.
