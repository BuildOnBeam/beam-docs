...
- The request client. We currently provide a **C# and Typescript** client.
...
The request client is a new client which can be used to generate [Operations](/service/operations/introduction). Both the request clients we offer for the new self-custodial services, are structured in similar fashion to the existing SDKs that offer custodial [Profiles](/service/profiles/introduction).
