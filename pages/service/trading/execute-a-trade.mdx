...
When you're trading assets between profiles, you want to be sure both parties involved in the trade get their due assets or tokens as proposed in the trade. We created a couple of [asset management](/service/assets/managing-profile-assets) methods to help you with managing assets, but the risk of using these methods is that if you move tokens or assets from profile A to B, and from B to A that one of the transactions could fail.
