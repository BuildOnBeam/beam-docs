...
<Callout emoji="🛠️">
  Beam is in developer preview mode! If you want access, take a look at the [how to get started](/service) and let's have a chat through build@onbeam.com 
</Callout>
...
- [Assets](/service/assets): Simplify in-game asset management and create a seamless marketplace with Beam's SDK.
...
<div className="mt-16 mb-20 text-center">
  [Beam](https://onbeam.com/) · [Merit Circle](https://meritcircle.io/) · [GitHub Repository](https://github.com/Merit-Circle/beam-docs)
</div>
