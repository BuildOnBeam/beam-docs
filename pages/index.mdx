...
- [Getting Started](/sdk): Learn how to kickstart your Beam integration with essential steps like API key acquisition.

- [SDK](/sdk/clients): Learn best practices for using Beam's official SDKs, including API key security.

- [Game](/sdk/game/introduction): A guide to managing and updating your game's assets and details within Beam.
...
- [Companion](/sdk/companion/introduction): Implement the Beam Companion app in your game.

- [Reporting](/sdk/reporting): Get some insight on how your game is doing in terms of on-chain transactions
...
<div className="mt-16 mb-20 text-center">
  ...
  Service](/sdk/terms-of-service) · [Support](https://support.onbeam.com/hc/en-us)
</div>
