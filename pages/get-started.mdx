...
## Beam: The Gaming Focused Blockchain
...
A crucial component of Beam's power and flexibility is its identity as an Avalanche subnet in the Avalanche ecosystem. In this role, Beam is not just an independent blockchain but is part of a vibrant, interconnected network. It benefits from the scale, speed, and security features of the Avalanche protocol, while also possessing the ability to operate individually with its specific focus on gaming applications. [Learn more](https://docs.avax.network/learn/avalanche/subnets-overview) about Avalanche Subnets.

Beam employs a reputation-based consensus method termed Proof of Authority (PoA), enhanced with the Snowman protocol. This set-up entrusts a selected group of reputable authorities to authenticate transactions, thereby safeguarding the blockchain's integrity. The PoA model emphasizes the value of the validators' reputations, with these validators being handpicked based on their trustworthiness. This allows for a highly scalable system where blocks and transactions are verified by pre-approved participants acting as system moderators.

The Snowman protocol, specifically crafted for Avalanche, is a high-throughput, totally ordered consensus protocol optimized for blockchain and particularly suited for smart contracts. [Learn more](https://docs.avax.network/learn/avalanche/avalanche-consensus) about the Avalanche Consensus ***(Tbd link to consensus config, once its decided)***


## The Role of the Merit Circle DAO Token 
...
- Getting MC Token
- [Setting up Metamask / RPC](/get-started/rpc)
- [Bridge Tokens to Beam](/beam-ecosystem/bridge)
- [Start Building on Beam](/builder/starter-guide)