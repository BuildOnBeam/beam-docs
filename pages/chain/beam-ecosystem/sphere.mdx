---
description: "Discover Sphere, Beam's native marketplace for trading unique NFTs. Explore a seamless user experience for acquiring in-game assets swiftly."
---
...
Sphere is Beam’s designated marketplace for buying, selling, and discovering unique Non-Fungible Tokens (NFTs). It caters to web3 users and enthusiasts looking to trade assets from their preferred games and collection—ranging from weapons, characters, and cosmetics to accounts and certificates of ownership. Designed with a seamless user experience, Sphere emphasizes the assets, enabling users to acquire their desired items swiftly.
