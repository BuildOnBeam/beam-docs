...
There are test token contracts deployed to Goerli and Fuji you can use to test bridging.
On _Goerli_ testnet, you can obtain USDC and USDT tokens from out test contracts via
...
On _Fuji_, you can bridge the native AVAX token, which you can claim from the [official faucet](https://core.app/tools/testnet-faucet).
After getting the tokens, you can use [bridge.onbeam.com](https://bridge.onbeam.com) as usual to transfer them to Beam Testnet.
