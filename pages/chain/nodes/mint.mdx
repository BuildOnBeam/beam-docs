...
In the upper right corner, press 'connect wallet'. This will open up a pop-up where you may select the wallet of your preference. This ranges from MetaMask, Phantom, Coinbase Wallet to virtually any possible wallet.
