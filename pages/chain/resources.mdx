...
<Cards.Card href="/chain/resources/glossary" title="Glossary" arrow />
 
</Cards>

- [Beam Testnet Faucet](https://core.app/tools/testnet-faucet/?subnet=beam&token=beam) ([Alternative Faucet](https://faucet.onbeam.com/), [ethfaucet.com](https://ethfaucet.com?utm_source=beam_docs&utm_medium=docs)): A testnet faucet for obtaining BEAM for testing purposes on the Beam Testnet.
...
You can find the Brand Identity Kit (Logo, etc) for Beam at [brand.onbeam.com](https://brand.onbeam.com/).
