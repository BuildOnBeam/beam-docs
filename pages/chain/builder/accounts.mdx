...
Some users may seek both ownership and assurance. You can offer them an option to share their backup key with you and Beam. Using techniques such as key fragmentation or multi-signature approach, you can provide a balance of control and security to these users.
...
## Learn more
- [Beam Companion App](/sdk/companion/introduction)
