...
<Callout type="info">
  At the current stage Beam is a permissioned network. To deploy contracts you need to be whitelisted first for security reasons. Reach out to us directly at hello@meritcircle.io.
</Callout>
