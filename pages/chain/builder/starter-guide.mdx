...
You can access Beam through MetaMask, by defining a custom network. Go to MetaMask, log in, click the network dropdown, and select 'Custom RPC'. Find the [Beam RPC settings here](/get-started/rpc).